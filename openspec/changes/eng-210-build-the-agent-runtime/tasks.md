...
- [x] 5.3 Implement the loop: take a step, dispatch any capability calls, append results, repeat; end the turn on content with nothing outstanding, and emit that content as the message to the parent.
